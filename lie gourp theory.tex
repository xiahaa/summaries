...
\draw (g0) node[above, right]  {$\bm{0}_{n \times n}$};
...
%  \draw (0,0) circle (2cm,0) arc (0:-180:1
  ...
  \tdplotsetthetaplanecoords{-60}
\draw[dashed,tdplot_rotated_coords] (2,1,0) arc (0:90:2);
\tdplotsetthetaplanecoords{-30}
\draw[dashed,tdplot_rotated_coords] (2,1,0) arc (0:90:2);
\tdplotsetthetaplanecoords{0}
\draw[dashed,tdplot_rotated_coords] (2,1,0) arc (0:90:2);
...
\tdplotsetthetaplanecoords{90}
\draw[dashed,tdplot_rotated_coords] (2,1,0) arc (0:90:2);
\shade[ball color = gray!40, opacity = 0.3] (-2.8,8) arc (0:-180:2cm and 12mm) arc (180:0:2cm and 2cm);  
